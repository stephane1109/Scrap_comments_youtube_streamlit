...
st.markdown(
    ...
    "Pour plus d'informations, visitez [CodeandCortex](https://codeandcortex.fr)."
)
...
option_recuperer_reponses = st.radio("Récupérer les réponses aux commentaires (niveau 2) ?", options=["Oui", "Non"],
                                     index=0)
option_supprimer_date = st.radio("Supprimer la date ?", options=["Oui", "Non"], index=1)
